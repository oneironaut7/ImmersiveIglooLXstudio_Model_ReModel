...
public class LSD extends LXEffect {
  ...
  public final BoundedParameter scale = new BoundedParameter("Scale", 100, 20, 200);
  public final BoundedParameter speed = new BoundedParameter("Speed", 2, .5, 6);
  public final BoundedParameter range = new BoundedParameter("Range", 2, .7, 4);
